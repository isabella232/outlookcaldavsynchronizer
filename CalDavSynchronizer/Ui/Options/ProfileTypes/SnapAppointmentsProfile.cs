...
namespace CalDavSynchronizer.Ui.Options.ProfileTypes
{
  class SnapAppointmentsProfile : ProfileBase
  {
    ...
    {
      data.CalenderUrl = "https://calendar.snapappointments.com/caldav.php/";
    }
